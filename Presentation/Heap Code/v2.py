...
# Remove the root node (minimum value) before heapify
if heap:
    removed_node = heap.pop(0)  # Simulating removal of root before heapify
    draw_heap(heap, f"Heap after Removing Root ({removed_node})")
